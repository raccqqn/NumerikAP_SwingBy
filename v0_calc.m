...
%Position bei Start berechnen
%Start an Erdoberfläche, tangential zur Erdlaufbahn ausgerichtet
pos = posEarth(0);
pos(1) = pos(1) + cos(angle_tan) * diam_earth / 2;
pos(2) = pos(2) + sin(angle_tan) * diam_earth / 2;

%Startgeschwindigkeit berechnen, Abschusswinkel wird berücksichtigt
